...
class Pangga extends Component {
    render() {
        return (
                    ...
                    <View style={{ flex: 1, backgroundColor: 'white', paddingTop: 50, }}>
                        <View style={styles.formContainer}>
                            <View style={{ textAlign: 'center', marginBottom: 20, paddingBottom: 15 }}>
                                <Text style={{ fontWeight: 'bold', fontSize: 35, color: '#00579C', textAlign: 'center' }}>Kapalzy</Text>
                            </View>
                            <View>
                                <View >
                                    <Input
                ...
                <View style={{ height: 60, backgroundColor: 'white', flexDirection: 'row', shadowColor: 'black', shadowRadius: 3, shadowOpacity: 0.3, position: 'relative' }}>
                    ...
                    <View style={{ flex: 1, alignItems: 'center', marginTop: 5, }}>
                        <View style={{ width: 26, height: 26, }}>
                            ...
                            <Image source={require('../utspam/assets/homeicon.png')} style={{ width: 28, height: 28, }} />
                    ...
                    <View style={{ flex: 1, alignItems: 'center', marginTop: 5, }}>
                        <View style={{ width: 26, height: 26, }}>
                            ...
                            <Image source={require('../utspam/assets/pesananicon.png')} style={{ width: 28, height: 28, }} />
                    ...
                    <View style={{ flex: 1, alignItems: 'center', marginTop: 5, }}>
                        <View style={{ width: 26, height: 26, }}>
                            <Image source={require('../utspam/assets/pembatalanicon.png')} style={{ width: 28, height: 28, }} />
                        </View>
